...
namespace Calculator
{
    ...
    /// Mathematical calculator
    /// </summary>
    public class MathCalculatorSupportingCalculatorDomain
    {
        private readonly MathOperation[] _operations;

        private readonly IParserSupportingCalculatorDomain _parser;
        private readonly INotationConverterSupportingCalculatorDomain _notationConverter;
        private readonly IMathProcessorSupportingCalculatorDomain _mathProcessor;
        ...
        /// <param name="mathProcessor">Processor for performing mathematical operations</param>
        /// <param name="operations">Mathematical operations</param>
        public MathCalculatorSupportingCalculatorDomain(IParserSupportingCalculatorDomain parser, INotationConverterSupportingCalculatorDomain notationConverter, IMathProcessorSupportingCalculatorDomain mathProcessor, MathOperation[] operations)
        {
            _parser = parser;
            _notationConverter = notationConverter;
            _mathProcessor = mathProcessor;
